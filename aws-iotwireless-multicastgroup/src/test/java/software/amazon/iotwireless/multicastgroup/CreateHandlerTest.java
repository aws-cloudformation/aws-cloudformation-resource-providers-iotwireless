...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateMulticastGroupResponse createMulticastGroupResponse = CreateMulticastGroupResponse.builder()
                .arn(TEST_ARN)
                .id(TEST_ID)
                .build();
        when(proxyClient.client().createMulticastGroup(any(CreateMulticastGroupRequest.class))).thenReturn(createMulticastGroupResponse);
