...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final UpdateMulticastGroupResponse updateMulticastGroupResponse = UpdateMulticastGroupResponse.builder()
                .build();
        ...
        when(proxyClient.client().updateMulticastGroup(any(UpdateMulticastGroupRequest.class))).thenReturn(updateMulticastGroupResponse);
