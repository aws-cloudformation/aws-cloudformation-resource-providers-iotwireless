...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteMulticastGroupResponse deleteMulticastGroupResponse = DeleteMulticastGroupResponse.builder()
                .build();

        when(proxyClient.client().deleteMulticastGroup(any(DeleteMulticastGroupRequest.class))).thenReturn(deleteMulticastGroupResponse);
