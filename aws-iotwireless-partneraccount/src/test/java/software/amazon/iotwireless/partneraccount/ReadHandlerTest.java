...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetPartnerAccountResponse getPartnerAccountResponse = GetPartnerAccountResponse.builder()
                .sidewalk(TEST_SIDEWALK_RESPONSE)
                .accountLinked(false)
                .build();
        ...
        when(proxyClient.client().getPartnerAccount(any(GetPartnerAccountRequest.class))).thenReturn(getPartnerAccountResponse);
