...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final UpdatePartnerAccountResponse updatePartnerAccountResponse = UpdatePartnerAccountResponse.builder()
                .build();
        ...
        when(proxyClient.client().updatePartnerAccount(any(UpdatePartnerAccountRequest.class))).thenReturn(updatePartnerAccountResponse);
