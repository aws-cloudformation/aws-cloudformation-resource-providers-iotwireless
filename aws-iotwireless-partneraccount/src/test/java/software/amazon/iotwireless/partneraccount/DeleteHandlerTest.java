...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DisassociateAwsAccountFromPartnerAccountResponse disassociateAwsAccountFromPartnerAccountResponse = DisassociateAwsAccountFromPartnerAccountResponse.builder()
                .build();

        when(proxyClient.client().disassociateAwsAccountFromPartnerAccount(any(DisassociateAwsAccountFromPartnerAccountRequest.class))).thenReturn(disassociateAwsAccountFromPartnerAccountResponse);
