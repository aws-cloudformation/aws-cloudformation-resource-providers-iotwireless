...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetWirelessGatewayTaskDefinitionResponse getWirelessGatewayTaskDefinitionResponse = GetWirelessGatewayTaskDefinitionResponse.builder()
                .name(TEST_NAME)
                .autoCreateTasks(false)
                .update(TEST_UPDATE_RESPONSE)
                .build();
        ...
        when(proxyClient.client().getWirelessGatewayTaskDefinition(any(GetWirelessGatewayTaskDefinitionRequest.class))).thenReturn(getWirelessGatewayTaskDefinitionResponse);
