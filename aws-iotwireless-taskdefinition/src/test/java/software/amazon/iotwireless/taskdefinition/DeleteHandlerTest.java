...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteWirelessGatewayTaskDefinitionResponse deleteWirelessGatewayTaskDefinitionResponse = DeleteWirelessGatewayTaskDefinitionResponse.builder()
                .build();

        when(proxyClient.client().deleteWirelessGatewayTaskDefinition(any(DeleteWirelessGatewayTaskDefinitionRequest.class))).thenReturn(deleteWirelessGatewayTaskDefinitionResponse);
