...
public class AbstractTestBase {
  ...
  static {
    ...
    TEST_LORA_CREATE = new software.amazon.iotwireless.serviceprofile.LoRaWANServiceProfile();
    TEST_LORA_CREATE.setAddGwMetadata(true);
    ...
    TEST_LORAWAN = software.amazon.awssdk.services.iotwireless.model.LoRaWANGetServiceProfileInfo.builder()
            .ulRate(1)
            .ulBucketSize(1)
            .ulRatePolicy(TEST_SERVICE_PROFILE_ID)
            .dlRate(2)
            .build();
...
=======
            .loRaWANServiceProfile(TEST_LORA_CREATE)
>>>>>>> upstream/main
            .tags(TEST_TAGS)
            .build();
