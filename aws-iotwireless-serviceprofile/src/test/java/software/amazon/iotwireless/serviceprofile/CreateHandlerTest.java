...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateServiceProfileResponse createServiceProfileResponse = CreateServiceProfileResponse.builder()
                .arn(TEST_ARN)
                .id(TEST_ID)
                .build();

        when(proxyClient.client().createServiceProfile(any(CreateServiceProfileRequest.class))).thenReturn(createServiceProfileResponse);
