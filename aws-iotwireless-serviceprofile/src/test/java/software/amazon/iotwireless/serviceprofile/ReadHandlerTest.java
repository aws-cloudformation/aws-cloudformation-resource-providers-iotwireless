...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetServiceProfileResponse getServiceProfileResponse = GetServiceProfileResponse.builder()
                .name(TEST_NAME)
                .id(TEST_ID)
        ...
        when(proxyClient.client().getServiceProfile(any(GetServiceProfileRequest.class))).thenReturn(getServiceProfileResponse);
