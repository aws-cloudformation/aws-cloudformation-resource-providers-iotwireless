...
public abstract class BaseHandlerStd extends BaseHandler<CallbackContext> {
    ...
    private String extractResourceIdFromFuotaRequests(final IotWirelessRequest request) {
        if (request instanceof DeleteFuotaTaskRequest) {
            final DeleteFuotaTaskRequest deleteFuotaTaskRequest = (DeleteFuotaTaskRequest) request;
            return deleteFuotaTaskRequest.id();
        }
        if (request instanceof GetFuotaTaskRequest) {
            final GetFuotaTaskRequest getFuotaTaskRequest = (GetFuotaTaskRequest) request;
            return getFuotaTaskRequest.id();
        }
        if (request instanceof UpdateFuotaTaskRequest) {
            final UpdateFuotaTaskRequest updateFuotaTaskRequest = (UpdateFuotaTaskRequest) request;
            return updateFuotaTaskRequest.id();
        } else {
            return "";
        }
    }

    public RuntimeException handleException(final Exception error, final IotWirelessRequest request, final String typeName, Function<IotWirelessRequest, String> extractResourceIdFromRequests) {
    ...
    public RuntimeException handleException(final Exception error, final IotWirelessRequest request) {
        return handleException(error, request, ResourceModel.TYPE_NAME, this::extractResourceIdFromFuotaRequests);
    }
}
