...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteFuotaTaskResponse deleteFuotaTaskResponse = DeleteFuotaTaskResponse.builder()
                .build();

        when(proxyClient.client().deleteFuotaTask(any(DeleteFuotaTaskRequest.class))).thenReturn(deleteFuotaTaskResponse);
