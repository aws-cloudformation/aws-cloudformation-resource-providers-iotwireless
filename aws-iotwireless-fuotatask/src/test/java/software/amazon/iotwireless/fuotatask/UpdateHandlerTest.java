...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final UpdateFuotaTaskResponse updateFuotaTaskResponse = UpdateFuotaTaskResponse.builder()
                .build();
        ...
        when(proxyClient.client().updateFuotaTask(any(UpdateFuotaTaskRequest.class))).thenReturn(updateFuotaTaskResponse);
