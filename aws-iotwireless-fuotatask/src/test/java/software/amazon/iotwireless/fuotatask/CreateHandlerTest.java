...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateFuotaTaskResponse createFuotaTaskResponse = CreateFuotaTaskResponse.builder()
                .arn(TEST_ARN)
                .id(TEST_ID)
                .build();
        when(proxyClient.client().createFuotaTask(any(CreateFuotaTaskRequest.class))).thenReturn(createFuotaTaskResponse);
