...
public class AbstractTestBase {
    ...
    protected static final String TEST_FUOTATASKSTATUS;
    ...
    static {
        ...
        TEST_FIRMWAREUPDATEIMAGE = "image";
        TEST_FIRMWAREUPDATEROLE = "role";
        TEST_FUOTATASKSTATUS = "Pending";
        ...
        TEST_FUOTATASK = ResourceModel.builder()
                ...
                .fuotaTaskStatus(TEST_FUOTATASKSTATUS)
                .build();
