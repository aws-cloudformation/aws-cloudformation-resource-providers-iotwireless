...
public class  CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateDestinationResponse createDestinationResponse = CreateDestinationResponse.builder()
                .arn(TEST_ARN)
                .name(TEST_NAME)
                .build();

        when(proxyClient.client().createDestination(any(CreateDestinationRequest.class))).thenReturn(createDestinationResponse);
