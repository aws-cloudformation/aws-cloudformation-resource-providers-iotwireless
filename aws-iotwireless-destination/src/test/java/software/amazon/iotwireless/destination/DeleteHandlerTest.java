...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteDestinationResponse deleteDestinationResponse = DeleteDestinationResponse.builder()
                .build();

        when(proxyClient.client().deleteDestination(any(DeleteDestinationRequest.class))).thenReturn(deleteDestinationResponse);
