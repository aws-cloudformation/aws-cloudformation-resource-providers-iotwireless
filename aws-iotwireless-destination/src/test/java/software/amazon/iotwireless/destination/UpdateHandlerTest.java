...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final UpdateDestinationResponse updateDestinationResponse = UpdateDestinationResponse.builder()
                .build();
        ...
        when(proxyClient.client().updateDestination(any(UpdateDestinationRequest.class))).thenReturn(updateDestinationResponse);
