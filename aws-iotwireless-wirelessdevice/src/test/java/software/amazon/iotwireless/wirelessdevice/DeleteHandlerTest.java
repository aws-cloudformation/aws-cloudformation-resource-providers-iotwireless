...
//        verifyNoMoreInteractions(proxyClient.client());
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteWirelessDeviceResponse deleteWirelessDeviceResponse = DeleteWirelessDeviceResponse.builder()
                .build();

        when(proxyClient.client().deleteWirelessDevice(any(DeleteWirelessDeviceRequest.class))).thenReturn(deleteWirelessDeviceResponse);
