...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateWirelessDeviceResponse createWirelessDeviceResponse = CreateWirelessDeviceResponse.builder()
                .arn(TEST_ARN)
                .id(TEST_ID)
                .build();

        when(proxyClient.client().createWirelessDevice(any(CreateWirelessDeviceRequest.class))).thenReturn(createWirelessDeviceResponse);
