...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetWirelessDeviceResponse getWirelessDeviceResponse = GetWirelessDeviceResponse.builder()
                .type(TEST_TYPE)
                .name(TEST_NAME)
        ...
        when(proxyClient.client().getWirelessDevice(any(GetWirelessDeviceRequest.class))).thenReturn(getWirelessDeviceResponse);
