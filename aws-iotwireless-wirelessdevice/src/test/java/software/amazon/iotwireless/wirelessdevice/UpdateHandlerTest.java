...
//        verifyNoMoreInteractions(sdkClient);
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final UpdateWirelessDeviceResponse updateWirelessDeviceResponse = UpdateWirelessDeviceResponse.builder()
                .build();
        ...
        when(proxyClient.client().updateWirelessDevice(any(UpdateWirelessDeviceRequest.class))).thenReturn(updateWirelessDeviceResponse);
