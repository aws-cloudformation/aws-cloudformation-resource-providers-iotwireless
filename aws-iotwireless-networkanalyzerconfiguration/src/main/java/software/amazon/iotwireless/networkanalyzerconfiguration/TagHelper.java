...
import software.amazon.iotwireless.networkanalyzerconfiguration.Tag;
...
public class TagHelper {
     ...
     */
    public static final Map<String, String> generateTagsForCreate(final ResourceHandlerRequest<ResourceModel> handlerRequest) {
