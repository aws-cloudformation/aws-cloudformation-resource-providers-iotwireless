...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetDeviceProfileResponse getDeviceProfileResponse = GetDeviceProfileResponse.builder()
                .arn(TEST_ARN)
                .id(TEST_ID)
                .name(TEST_NAME)
        ...
        when(proxyClient.client().getDeviceProfile(any(GetDeviceProfileRequest.class))).thenReturn(getDeviceProfileResponse);
