...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final UpdateWirelessDeviceImportTaskResponse updateWirelessDeviceImportTaskResponse= UpdateWirelessDeviceImportTaskResponse.builder()
                .build();
        ...
        when(proxyClient.client().updateWirelessDeviceImportTask(any(UpdateWirelessDeviceImportTaskRequest.class))).thenReturn(updateWirelessDeviceImportTaskResponse);
