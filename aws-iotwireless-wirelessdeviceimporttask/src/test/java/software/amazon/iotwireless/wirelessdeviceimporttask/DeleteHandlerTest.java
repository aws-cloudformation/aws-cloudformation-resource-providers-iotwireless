...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteWirelessDeviceImportTaskResponse deleteWirelessDeviceImportTaskResponse = DeleteWirelessDeviceImportTaskResponse.builder().build();

        when(proxyClient.client().deleteWirelessDeviceImportTask(any(DeleteWirelessDeviceImportTaskRequest.class))).thenReturn(deleteWirelessDeviceImportTaskResponse);
