...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetWirelessDeviceImportTaskResponse getWirelessDeviceImportTaskResponse= GetWirelessDeviceImportTaskResponse.builder()
                .id(TEST_ID)
                .arn(TEST_ARN)
                ...
                .initializedImportedDeviceCount(TEST_INITIALIZED_IMPORTED_DEVICES_COUNT)
                .pendingImportedDeviceCount(TEST_PENDING_IMPORTED_DEVICES_COUNT)
                .onboardedImportedDeviceCount(TEST_ONBOARDED_IMPORTED_DEVICES_COUNT)
                .failedImportedDeviceCount(TEST_FAILED_IMPORTED_DEVICES_COUNT)
                .build();
        ...
        when(proxyClient.client().getWirelessDeviceImportTask(any(GetWirelessDeviceImportTaskRequest.class))).thenReturn(getWirelessDeviceImportTaskResponse);
