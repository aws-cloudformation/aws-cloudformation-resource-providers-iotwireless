...
//        verifyNoMoreInteractions(sdkClient);
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteWirelessGatewayResponse deleteWirelessGatewayResponse = DeleteWirelessGatewayResponse.builder()
                .build();

        when(proxyClient.client().deleteWirelessGateway(any(DeleteWirelessGatewayRequest.class))).thenReturn(deleteWirelessGatewayResponse);
