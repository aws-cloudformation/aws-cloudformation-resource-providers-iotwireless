...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final GetWirelessGatewayResponse getWirelessGatewayResponse = GetWirelessGatewayResponse.builder()
                .name(TEST_NAME)
                .id(TEST_ID)
        ...
        when(proxyClient.client().getWirelessGateway(any(GetWirelessGatewayRequest.class))).thenReturn(getWirelessGatewayResponse);
