...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateWirelessGatewayResponse createWirelessGatewayResponse = CreateWirelessGatewayResponse.builder()
                .arn(TEST_ARN)
                .id(TEST_ID)
                .build();

        when(proxyClient.client().createWirelessGateway(any(CreateWirelessGatewayRequest.class))).thenReturn(createWirelessGatewayResponse);
